...
FILE_NAME_REGEX: Final[re.Pattern[str]] = re.compile("[a-zA-Z0-9_][a-zA-Z0-9_.-]{0,254}")
...
class ARGS:
    def __init__(self, source: str | Path, **kwargs: Any) -> None:
        ...
        self.no_test_case_sanity_checks: bool = get_arg("no_test_case_sanity_checks", False)
        ...
        self.test_cases: Optional[list[Path]] = get_list_arg("test_cases", Path)
